  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Paramedis</li>
      </ol>
    </section>
  
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">EDIT DATA PARAMEDIS</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php foreach ($paramedis as $d ) { ?>
             <form role="form" action="<?php echo base_url().'master/update_paramedis' ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Nama</label>

                  <div class="col-sm-10">
                    <input type="hidden" name="id_paramedis" value="<?php echo $d->id_paramedis ?>">
