      ...
      <ol class="breadcrumb">
        ...
        <div class="box box-primary">
            ...
            <?php foreach ($jabatan as $d ) { ?>
             <form role="form" action="<?php echo base_url().'master/update_jabatan' ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Nama</label>

                  <div class="col-sm-10">
                    <input type="hidden" name="id_jabata  n" value="<?php echo $d->id_jabatan ?>">
